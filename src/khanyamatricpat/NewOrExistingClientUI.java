 ...
 * @author 24khanyam
 */
public class NewOrExistingClientUI extends javax.swing.JFrame {

    /**
     * Creates new form NewOrExistingLP
     */
    public NewOrExistingClientUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        iamlbl.setFont(new java.awt.Font("MV Boli", 1, 18)); // NOI18N
        iamlbl.setText("I am:");
...
//this takes  the user back to the login page
    ...
    private void newbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newbtnActionPerformed
        RegisterCustomerUI rc = new RegisterCustomerUI();
        rc.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewOrExistingClientUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewOrExistingClientUI().setVisible(true);
            }
        });
    }
